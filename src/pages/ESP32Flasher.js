        ...
        <Alert status="warning" mb={6} borderRadius="md">
          ...
          <Box>
            ...
            <Text fontSize="sm">
              ...
              Firefox and other browsers are not compatible.
            </Text>
          </Box>
        </Alert>
      )}
      <Accordion allowToggle key={isCompatibleBrowser} defaultIndex={isCompatibleBrowser ? [0] : []}>
        <AccordionItem>
          <AccordionButton 
            bg={headerBg} 
            ...
            borderRadius="md"
            mb={2}
            display={!isCompatibleBrowser ? "inline" : "none"}
          >
            <HStack flex="1" textAlign="left" display="inline">
              <Heading as="h2" size="md" display="inline">
                Attempt Flash from Incompatible Browser
              </Heading>
              <AccordionIcon />
            </HStack>
          </AccordionButton>
